...
"""
    ...
    func test6CustomDataValuesXML() {
        ...
        let expectedEdges = [
            EdgeStruct(source: "n3", target: "n4"),
            EdgeStruct(source: "n2", target: "n8"),
            EdgeStruct(source: "n1", target: "n5"),
            EdgeStruct(source: "n4", target: "n0"),
            EdgeStruct(source: "n6", target: "n8"),
            EdgeStruct(source: "n7", target: "n9"),
            EdgeStruct(source: "n7", target: "n0"),
            EdgeStruct(source: "n8", target: "n6"),
            EdgeStruct(source: "n1", target: "n6"),
            EdgeStruct(source: "n3", target: "n3"),
            EdgeStruct(source: "n8", target: "n0"),
            EdgeStruct(source: "n6", target: "n1"),
            EdgeStruct(source: "n9", target: "n2"),
            EdgeStruct(source: "n5", target: "n7"),
            EdgeStruct(source: "n2", target: "n4"),
            EdgeStruct(source: "n9", target: "n5"),
            EdgeStruct(source: "n0", target: "n0"),
            EdgeStruct(source: "n4", target: "n2"),
            EdgeStruct(source: "n5", target: "n2"),
        ]
        XCTAssertEqual(graph, Graph(vertices: expectedVertices, edges: expectedEdges, directed: .undirected))
    }
}
